@echo off
echo ========================================================
echo   GENERANDO ARCHIVO BUNDLE (.AAB) PARA GOOGLE PLAY STORE
echo ========================================================
echo.
...
echo Paso 4: Construyendo el archivo Android App Bundle (.aab)...
cd android
...
echo ========================================================
echo.
echo Tu NUEVO archivo App Bundle (.aab) se ha guardado en la siguiente ruta:
echo.
echo C:\Users\grd_a\.gemini\antigravity\scratch\Veta_Vigor_App\android\app\build\outputs\bundle\release\app-release.aab
echo.
echo 1. Abre tu consola de Google Play (Google Play Console).
echo 2. Crea una nueva version y sube este archivo .aab.
pause
