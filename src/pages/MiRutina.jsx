...
import { getFraseDelDia } from '../data/frasesDelDia';
...
export default function MiRutina({ session }) {
  ...
  // hoy, el nivel, el último entrenamiento, el progreso semanal y la frase
  // del día cada vez que cambian, para que se vean sin abrir la app. No
  // hace nada en web -- actualizarWidget() ya revisa
  ...
  useEffect(() => {
    ...
    actualizarWidget({
      ...
      fraseDelDia: getFraseDelDia().text,
    });
